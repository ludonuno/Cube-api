...
var GetPessoa = (id, nome, dataNascimento, callback) => {
  return new Promise((resolve, reject) => {
    ...
    if (nome && dataNascimento)
      query = `SELECT * FROM ${tabela.tabela} WHERE ${
        tabela.nome
      } like '%${nome}%' AND ${tabela.dataNascimento} = '${dataNascimento}'`;
...
var CreatePessoa = (nome, foto, dataNascimento, biografia, callback) => {
  return new Promise((resolve, reject) => {
    ...
    if (dataNascimento) {
      query += ` (${tabela.nome},${tabela.foto},${tabela.dataNascimento},${
        tabela.biografia
      }) VALUES ('${nome}', ${foto}, '${dataNascimento}', '${biografia}')`;
    } else {
      query += ` (${tabela.nome},${tabela.foto},${
        tabela.biografia
      }) VALUES ('${nome}', ${foto}, '${biografia}')`;
    }
    db.query(query, (error, result) => {
