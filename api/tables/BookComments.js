...
var CreateQuerySelect = (bookId, responseTo, callback) => {
	return new Promise((resolve, reject) => {
		HandleSelectData(bookId, responseTo, (error, result) => {
			error ? reject(error) : resolve(`SELECT ${table.table}.${table.id}, ${table.table}.${table.userId}, ${table.table}.${table.bookId}, ${table.table}.${table.comment}, ${table.table}.${table.responseTo}, ${userTable
