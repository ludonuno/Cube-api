...
var CreateParentAdvisoryMovie = (rate, description, callback) => {
	return new Promise((resolve, reject) => {
...
var UpdateParentAdvisoryMovie = (id, rate, description, callback) => {
	return new Promise((resolve, reject) => {
		GetParentAdvisoryMovie(id, (error, result) => {
...
var DeleteParentAdvisoryMovie = (id, callback) => {
	return new Promise((resolve, reject) => {
		GetParentAdvisoryMovie(id, (error, result) => {
