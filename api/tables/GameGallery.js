...
var CreateQuery = (id, photo, gameId, callback) => {
  	return new Promise ((resolve, reject) => {
		switch (action) {
			case 'get': 
...
var CreateGameGallery = (photo, gameId, callback) => {
	return new Promise((resolve, reject) => {
...
var DeleteGameGallery = (id, callback) => {
	return new Promise((resolve, reject) => {
		GetGameGallery(id, undefined, (error, result) => {
