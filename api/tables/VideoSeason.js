...
var CreateQuery = (id, link, seasonId, callback) => {
  	return new Promise ((resolve, reject) => {
		switch (action) {
			case 'get': 
...
var CreateVideoSeason = (link, seasonId, callback) => {
	return new Promise((resolve, reject) => {
...
var DeleteVideoSeason = (id, callback) => {
	return new Promise((resolve, reject) => {
		GetVideoSeason(id, undefined, (error, result) => {
