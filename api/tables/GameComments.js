...
var CreateQuerySelect = (gameId, responseTo, callback) => {
	return new Promise((resolve, reject) => {
		HandleSelectData(gameId, responseTo, (error, result) => {
			error ? reject(error) : resolve(`SELECT ${table.table}.${table.id}, ${table.table}.${table.userId}, ${table.table}.${table.gameId}, ${table.table}.${table.comment}, ${table.table}.${table.responseTo}, ${userTable
