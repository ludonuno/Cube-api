...
var CreateQuerySelect = (movieId, responseTo, callback) => {
	return new Promise((resolve, reject) => {
		HandleSelectData(movieId, responseTo, (error, result) => {
			error ? reject(error) : resolve(`SELECT ${table.table}.${table.id}, ${table.table}.${table.userId}, ${table.table}.${table.movieId}, ${table.table}.${table.comment}, ${table.table}.${table.responseTo}, ${userTable
