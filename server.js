    ...
    switch (req.params.tabela) {
		...
		case routeList.tipo.nome:
			if (routeList.tipo.disponibilidade.post) {
				if (req.query.descricao) api.tipo.CreateTipo(req.query.descricao, (error, result) => res.json(error ? { error } : { result }))
				else res.json(errorList.parametros)
			} else res.json(errorList.indisponivel)
			break
		case routeList.tvPG.nome:
    ...
    switch (req.params.tabela) {
		...
		case routeList.tipo.nome:
			if (routeList.tipo.disponibilidade.put) {
				if (req.query.id && req.query.descricao) api.tipo.UpdateTipo(req.query.id, req.query.descricao, (error, result) => res.json(error ? { error } : { result }))
				else res.json(errorList.parametros)
			} else res.json(errorList.indisponivel)
			break
		case routeList.tvPG.nome:
    ...
    switch (req.params.tabela) {
		...
		case routeList.tipo.nome:
			if (routeList.tipo.disponibilidade.delete) {
				if (req.query.id) api.tipo.DeleteTipo(req.query.id, (error, result) => res.json(error ? { error } : { result }))
				else res.json(errorList.parametros)
			} else res.json(errorList.indisponivel)
			break
		case routeList.tvPG.nome:
