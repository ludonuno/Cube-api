...
DROP TABLE my_EpisodeComments, my_EpisodeRating, my_SeriesComments, my_BookComments, my_MovieComments, my_GameComments, my_BookRating, my_MovieRating, my_GameRating, my_User, my_CelebrityAssignmentSeries, my_CelebrityAssignmentBook, my_CelebrityAssignmentMovie, my_CelebrityAssignmentGame, my_Celebrity, my_Assignment, my_VideoEpisode, my_VideoSeason, my_VideoSeries, my_VideoBook, my_VideoMovie, my_VideoGame, my_GenreSeries, my_GenreBook, my_GenreMovie, my_GenreGame, my_Genres, my_Episode, my_Season, my_Series, my_Book, my_PublishingCompany, my_Movie, my_Developers, my_Game, my_Saga, my_Engine, my_ParentAdvisory, my_Company